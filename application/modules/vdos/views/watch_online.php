...
<ol class="breadcrumb" style="margin-bottom: 5px;">
  ...
  <li><a href="vdos/view/<?=$vdo->category->slug?>"><?=$vdo->category->name?></a></li>
		...
		<table class="table table-striped table-bordered table-condensed ep-list">
		  ...
		  <tbody>
              ...
              ?>
		        <tr>
		          <td>
		          	<a class="btn btn-primary" role="button" href="vdos/series_online/ดูซีรีย์เกาหลี-<?=clean_url($vdo->category->name)?>-<?=$ep->title?>-ซับไทย-ออนไลน์-<?=$ep->id?>"><?=$ep->title?></a>
