...
<head>
    ...
    <title><?php echo $sticker->title?> - บริการรับฝากซื้อสติ๊กเกอร์ไลน์แบบส่ง Gift ราคาถูกโดย LINE Thailand Fanclub</title>
    ...
    <meta name="keywords" content="LINE,Sticker,สติ๊กเกอร์,ไลน์,Gift,ขายสติ๊กเกอร์ไลน์,ฝากซื้อสติ๊กเกอร์ไลน์,<?php echo $sticker->title?>">
...
<div class="span12">
    ...
    <img src="<?php echo $sticker->preview?>" alt="<?php echo $sticker->title?>">
    <!-- <br><br>
    <a href="lines/download/<?php echo $sticker->id?>"><div class="btn btn-primary btn-large">Save Picture</div></a> -->
    </center>
</div>
</div>
