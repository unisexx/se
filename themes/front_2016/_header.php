<nav class="navbar navbar-fixed-top navbar-inverse">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://www.kpoplover.com" title="อัพเดทข่าวเกาหลี เพลงเกาหลี ซีรีย์เกาหลีใหม่ล่าสุด - Kpoplover">kpoplover</a>
    </div>
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        <li class="active"><a href="home">Home</a></li>
        <li><a href="ข่าวเกาหลี">News</a></li>
...
<div class="container header-blk">
	<div class="row">
		<div class="alert alert-block span12" style="background-color:#fff;border:2px dotted red; padding-top:0px;padding-bottom:0px;">
            <a href="http://www.line2me.in.th" target="_blank" style="color:#000; text-shadow: 0 0 0.2em #8F7"><h3 style="text-align: center; background: yellow;">สนใจฝากซื้อสติ๊กเกอร์ไลน์ของแท้โดยทีมงาน kpoplover คลิกเลยจ้า</h3></a>
        </div>
		<!--
	    <?php $random = rand(1,2);?>
	    <?php if($random == 1):?>
...
<div class="navbar">
  <div class="navbar-inner">
    ...
    <ul class="nav">
      ...
      <li><a href="ข่าวเกาหลี">ข่าว</a></li>
      <li class="divider-vertical"></li>
      <li><a href="มิวสิควีดีโอเพลงเกาหลี">มิวสิควีดีโอ</a></li>
      <li class="divider-vertical"></li>
